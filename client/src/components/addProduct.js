...
const AddProduct = () => {
  ...
  return (
    <>
      ...
      <h3 style={{ marginTop: "6vh", fontFamily: "Mulish" }}>Add a Dish{" "}<img src='https://res.cloudinary.com/ggsipu/image/upload/v1662799960/7058638_jv5xoy.png' style={{height: '10vh'}}/></h3>
