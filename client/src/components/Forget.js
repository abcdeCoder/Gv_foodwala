  ...
  return (
    <>
      ...
      <h4 style={{ marginTop: "6vh", fontFamily: "Mulish" }}>
        Forgot your Password? <img src='https://res.cloudinary.com/ggsipu/image/upload/v1662808165/forgot-password-icon-27_u64dhe.png' alt='forgot' style={{height:'2.5rem'}} />
      </h4>
