      ...
      <>
        <div className="pastOrderContainer animate__animated animate__fadeIn">
          <h1>
            Current Orders{" "}
            <img
              src="https://res.cloudinary.com/ggsipu/image/upload/v1662797039/icon-300x300_tu6sjl.png"
              alt="icon"
      ...
      <>
        <div className="pastOrderContainer animate__animated animate__fadeIn">
          <h1>
            Past Orders{" "}
            <img
              src="https://res.cloudinary.com/ggsipu/image/upload/v1662799616/icons8-purchase-order-64_npo9xg.png"
              alt="icon"
              style={{ width: "10%", height: "10%" }}
            />
          </h1>
