...
Router.post("/", auth, async (req, res) => {
  ...
  ((params["ORDER_ID"] = order_id.toString()),
    ...
    (params["CALLBACK_URL"] = `http://${process.env.HOST}/api/paytm/success`),
...
Router.post("/success", async (req, res) => {
  ...
  if (y.RESPCODE !== "01") {
    ...
    res.redirect(`http://${process.env.HOST}/fail`);
    ...
    var mailOptions = {
      ...
      text: "That was easy!",
      html: "Hi, <strong>" + name + "</strong><h2>Order Successfully Placed!</h2><h3><p>Thank you for ordering from GV FOODWALLAH</h3> Your order id: " + id + "</p><p style='text-align: left;'>Regards, GV FOODWALLAH</><div><strong><h1>Contact Us</h1><ul><li><a href='https://www.linkedin.com/in/gaurav-verma-88056a224/'>Linkedin</a></li> <li><a href='https://github.com/abcdeCoder'>Github</a></li> <li><a href='https://abcdecoder.github.io/portfolio.github.io/'>Portfolio</a></li></ul></strong></div>",
    };
    await transporter.sendMail(mailOptions, async (error, info) => {
      if (error) {
        ...
        res.redirect(`http://${process.env.HOST}/success?orderid=` + body.ORDERID)
      }
    });
